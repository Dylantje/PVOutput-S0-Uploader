...
void ShowStatus(EthernetClient client)
{
    ...
    client << F(" ********************************************");  
    client << F(" <br>"); 
    client << F("PVO upload fout:..") << pvResponse << " @ " << DateTime(pvResponseTime) << br;
    client << F(" ********************************************");
    client << F(" <br>");     
    client << F("DNS =...") << DnsStatus << br;
    client << F(" ********************************************"); 
    client << F(" <br>"); 
    client << F("Actuele Datum & Tijd:... ") << DateTime(now()) << br;
    client << F(" ********************************************"); 
    client << F(" <br>");  
    client << F("Tijd gesynchroniseerd op:...") << DateTime(lastTimeUpdate) << " (in " << ntpRetry << "x)" <<  br;
    client << F(" ********************************************"); 
    client << F(" <br>"); 
    client << F("De PVO S0 uploader loopt al:...") << upTime/24 << "d.&." << upTime%24 << "h" << br;
    client << F(" ********************************************"); 
    client << F(" <br>"); 
    ...
    client << F(" ********************************************"); 
    client << F(" <br>"); 
    client << F("Heel veel plezier met de PVO S0 uploader."); 
    client << F(" <br>"); 
    client << F(" ********************************************"); 
    client << F(" <br>"); 
